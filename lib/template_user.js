             ...
             upload_tag = `
               <div class="filebox"">
                 <form action='/teamcc/image_upload?rand=${random_url}' class="upload_bt" id="form_bt_${activitycc[prev_temp].id}" method="post" enctype="multipart/form-data">
                   ...
                   <input type="hidden" name="actindex" value="${activity_index}" />
                 </form>
               </div>
             `;
             uploadCount_tag = `
              ...
              if(count_index[activitycc[i].id-1].activity_num === 1){
                tag += `
                  <tr>
                    ...
                    <td class="tdCSS">${activitycc[i].score}점</td>
                ...
                tag += `
                  <tr>
                    ...
                    <td class="tdCSS_snd">${activitycc[i].score}점</td>
                      ...
                      if(n+1 === 1){
                        ...
                        tag += `
                          <tr>
                            ...
                            <td class="tdCSS">
                              <div class="filebox">
                                <form action='/teamcc/image_upload?rand=${random_url}' class="upload_bt" id="form_bt_${activitycc[i].id}" method="post" enctype="multipart/form-data">
                                  <label for="ex_file_${activitycc[i].id}"> 업로드</label>
                                  <input type="file" id="ex_file_${activitycc[i].id}" name="userfile" accept="image/*" required onchange="img(this,${activitycc[i].id})" />
                                  <input type="hidden" name="actid" value=${activitycc[i].id} />
                                  <input type="hidden" name="actUpload_num" value=${n+1} />
            ...
            upload_tag = `
              <div class="filebox"">
                <form action='/teamcc/image_upload?rand=${random_url}' class="upload_bt" id="form_bt_${activitycc[i].id}" method="post" enctype="multipart/form-data">
                  ...
                  <input type="hidden" name="rand_url" value="${random_url}" />
                  <input type="hidden" name="team_num" value="${team_num}" />
                  <input type="hidden" name="actindex" value="1" />
                </form>
              </div>
            `;
            uploadCount_tag = `
              ...
              upload_tag = `
                <div class="filebox"">
                  <form action='/teamcc/image_upload?rand=${random_url}' class="upload_bt" id="form_bt_${activitycc[i].id}" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="rand_url" value="${random_url}" />
                    <input type="hidden" name="team_num" value="${team_num}" />
                    <input type="hidden" name="actindex" value="${n+1}" />
                  </form>
                </div>
              `;
              uploadCount_tag = `
