        ...
        if(team_info[0].state === "Yes"){// member state on
          ...
          tag += `
            ...
            <tr>
              ...
              <td class="tdCSS">${activitycc[i].score}</td>
              <td class="tdCSS">
              <img id="img_${activitycc[i].activity_id}_${activitycc[i].activity_index}" src="data:${activitycc[i].mimetype};base64,${activitycc[i].image}" width=150vw height=auto onclick="modal(${activitycc[i].activity_id})"/></td>
              <td class="tdCSS"></td>
            </tr>
          `;
        }
