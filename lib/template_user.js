module.exports = {
  //----------------------   user  -----------------------------
  //user 화면 기본 html
  user_HTML:function( body, control,team_num,team_name){
  ...
  activityList:function(activity){
    ...
    while(i < activity.length){
        tag += `
            <tr>
                <td width = 30px> ${activity[i].id}</td>
                <td width = 400px>${activity[i].activity}</td>
                <td width = 30px>${activity[i].score}</td>
            </tr>
        `
        i++;
    }
