	 ...
	 if(check >= 0){
	  if(team_info[0].state === "Yes"){
          ...
          tag += `<tr>
                    ...
                    <img src="data:${activitycc[check].mimetype};base64,${activitycc[check].image}" width=150vw height=auto/></td>
                    <td style="border-bottom:2px solid lightgrey;">${delete_tag}</td>
                  </tr>`;
          i++;
        }else{
	  if(team_info[0].state === "Yes"){
          ...
          tag += `
              <tr>
                  ...
                  <td style="border-bottom:2px solid lightgrey;">${activitylist[i].activity}</td>
                  <td style="border-bottom:2px solid lightgrey;">${activitylist[i].score}</td>
                  <td style="border-bottom:2px solid lightgrey;">${upload_tag}</td>
                  <td style="border-bottom:2px solid lightgrey;"></td>
              </tr>
          `;
