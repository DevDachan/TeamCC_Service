...
exports.login = function(request, response,queryData){
  db.query(`SELECT * FROM activity`, function(error, activity){  if(error){throw error;}
    db.query(`SELECT * FROM count WHERE id='admin' ORDER BY CAST(year AS int) DESC, CAST(month AS int) DESC,CAST(day AS int) DESC`,function(error2,count){  if(error2){throw error2;}
...
exports.main = function(request,response){
  ...
  db.query(`SELECT * FROM count WHERE id='admin' ORDER BY CAST(year AS int) DESC, CAST(month AS int) DESC,CAST(day AS int) DESC`,function(error1,count){  if(error1){throw error1;}
