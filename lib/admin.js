...
exports.register_state = function(request,response){
  ...
  request.on('end', function(){
    ...
    var backURL = 'http://handongapp.cafe24.com/admin_register';
        ...
        if(result[0] !== undefined){
          var err_html = `
            ...
            <html>
              ...
              <body>
                <script>
                  window.open('http://localhost/alert_popup?content=이미 존재하는 아이디입니다!', '팝업 테스트', 'width=460, height=130, top=10, left=100');
                  location.href = 'http://localhost/admin_register';
                </script>
              </body>
            </html>`;
          response.writeHead(200);
