...
module.exports = {
  ...
  HTML_developerLogin:function(){
    ...
    // 개발자 관리 페이지 로그인 
    HTML_developerMain:function(alertFlag, totalViewers, adminViewers, userViewers, imgCount, teamNum){
                    ...
                    <div id="content">
                        ...
                        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                            ...
                            <a href="http://handongapp.cafe24.com/teamcc" style="text-decoration: none; color: inherit;">
                                <div id="logoTitle">TeamCC WEB Service</div>
                            </a>
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                        Total Viewers</div>
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800">👀 ${totalViewers}</div>
                                                </div>
                                                <div class="col-auto">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                        Admin Viewers</div>
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800">👀 ${adminViewers}</div>
                                                </div>
                                                <div class="col-auto">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                        User Viewers</div>
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800">👀 ${userViewers}</div>
                                                </div>
                                                <div class="col-auto">
