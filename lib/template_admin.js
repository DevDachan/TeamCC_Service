      ...
      <body id="page-top">
        ...
        <header class="masthead text-center text-white" style="background: linear-gradient(0deg, #ff6a00 0%, #ee0979 100%);">
          <div class="masthead-content">
            <div class="container px-5">
              <h1 class="masthead-heading mb-0">TEAM cc 생성</h1>       <br />
    ...
    <html lang="en">
      ...
      <!-- Header -->
        <header class="masthead text-center text-white"  style="">
          <div class="masthead-content" style="margin-bottom: 50px;">
...
//----------------------------  color select -------------------------------------
    ...
    for(var i=0; i< score_color_db.length; i++){
      color_table +=`
        <tr>
          ...
          <td><input type="color" onChange="color_pick('${admin_id}','${score_color_db[i].score}',this)" name="color_${score_color_db[i].score}" value="${score_color_db[i].color}" style="border:0px;"></input></td>
          <td>내용 색</td>
          <td><input type="color" onChange="color_pick('${admin_id}','${text_color_db[i].score}',this)" name="color_${text_color_db[i].score}" value="${text_color_db[i].color}" style="border:0px;"></input></td>
        </tr>`;
    }

    color_table +=`
      <tr>
        <td colspan=4>상태 변경</td>
      </tr>
      <tr>
        <td colspan=2>배경</td>
        <td colspan=2><input type="color" onChange="color_pick('${admin_id}','background',this)" name="background" value="${background_color}" style="border:0px;"></input></td>
      </tr>
      <tr>
        <td colspan=2>제목</td>
        <td colspan=2><input type="color" onChange="color_pick('${admin_id}','title_color',this)" name="title_color" value="${title_color}" style="border:0px;"></input></td>
      </tr>
      <tr>
        <td colspan=2>학점</td>
        <td colspan=2><input type="color" onChange="color_pick('${admin_id}','score_color',this)" name="score_color" value="${score_color}" style="border:0px;"></input></td>
      </tr>`;

    var input_text = `
      <tr>
        <td colspan=4>이름 변경</td>
      </tr>
      <tr>
        <td colspan=4>
          <input type="text" onChange="change_title('${admin_id}', this)" name="new_title" style="padding:5px;" value="${team_info.title}" />
        </td>
      </tr>`;
    ...
    table += `
      <table style="margin:auto; margin-top:30px;">
        <tr>
          <td colspan=4 style="width:100px;">학점</td>
        </tr>
        ${color_table}
        ${input_text}
      </table>`;
          ...
          <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
            <div class="container px-5" style="margin: 0;">
              ...
              <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <img src="assets/img/profileIcon.png" width="40px;">
              </div>
            </div>
          </nav>
          <!-- Header-->
          ...
          <section>
            <div class="container px-5">
              <div class="row gx-5 align-items-center">
                ...
                <div class="col-lg-6">
                  <div class="p-5">
                    <div style="display:grid; grid-template-columns:1fr 1fr; place-items:centers;">
                      <h2 class="display-4" style="position: relative; top: 25px; grid-row:1; grid-column:1; font-weight: 500;">URL</h2>
				              <p style="grid-row:1;grid-column:2; text-align:center; height: 40px; padding-top: 15px; margin:0px; font-weight:bold; font-size: 20px;">Member State</p>
				              <div class="wrapper" style="grid-row:1; grid-column:3; height: 40px; margin-right: 20px;">
				                ${check_state}
                    ...
                    <form action="/url_insert" method="post">
                      ...
                      <input type="submit" style="float: right; margin-bottom: 20px; margin-top: -20px; background-color: #6281D7; border-radius: 20px; vertical-align: middle; box-shadow: 3px 3px 5px grey; border:none;  height:40px; width:190px; color: white; font-size: 15px;" value="Add CCTeam(URL)">
                    </form>
				            <table width="100%">
