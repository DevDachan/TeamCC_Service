  ...
  urlTable:function(url,team_num){
    ...
    for(var i = 0; i< url.length; i++){
      ...
      <tr>
        ...
        <td>
        <a href="http://teamcc.cafe24.com:3000/user?id=${url[i].url}">http://teamcc.cafe24.com:3000/user?id=${url[i].url}</td>
        <td>
        ...
        <td>
          ...
          <script type="text/javascript">
              function kakaoShare(url_num) {
                  ...
                  Kakao.Link.sendDefault({
                      ...
                      , content : {
                          title:"Team CC 링크"
                          , description:"http://teamcc.cafe24.com:3000/user?id=" + url_num  // 콘텐츠 설명
                          , imageUrl:"https://ifh.cc/g/CAOojM.png" // 썸네일 같은거
                          , link : {
                              mobileWebUrl:"http://teamcc.cafe24.com:3000/user?id=" + url_num    // 모바일 카카오톡에서 사용하는 웹 링크 URL
                              , webUrl:"http://teamcc.cafe24.com:3000/user?id=" + url_num  // PC버전 카카오톡에서 사용하는 웹 링크 URL
                          }
                      }, buttons : [
          ...
          <a href="http://teamcc.cafe24.com:3000/admin_main" id="kakao_href"></a>
                              ...
                              <div class="p-5">
                                  ...
                                  <form action="admin_update_state" id="info_form" method="post" enctype="multipart/form-data">
                                    <div id="info_grid">
                                      ...
                                      <input type="file" id="background_image" name="background_image" accept="image/*" required onchange="select_img(this)" style="display:none; border:0px;" />
