      ...
      <body id="page-top" class="backgroundCSS">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
          <div class="container px-5">
            <a class="navbar-brand" href="/admin_main">Admin Page</a>
          </div>
        </nav>
        <!-- Header -->
      ...
      <head>
        ...
        <script>
          function deleteFunction(){
            ...
            opener.parent.location = 'http://handongapp.cafe24.com/admin_create';
            window.close();
          }
        </script>
      </head>
                ...
                <form style="  margin:auto;width:400px;" action="/admin_register_state" method="post">
                  <div id="grid">
                    ...
                    <input id="bt_login" type="submit" value="CREATE" class="btn btn-primary btn-xl rounded-pill mt-5" ></input>
			          ...
			          <a href="http://handongapp.cafe24.com/" class="btn btn-primary btn-xl rounded-pill mt-5" style="width:180px;">BACK</a>
              </div>
            </div>
            <div class="bg-circle-1 bg-circle"></div>
            <div class="bg-circle-2 bg-circle"></div>
          ...
          <script>
            function profile_edit(){
              ...
              $.ajax({
                type:'post',
                async:false,
                url:'http://handongapp.cafe24.com/admin_profile_check',
                dataType:'text',
                data:{
          ...
          <header class="masthead text-center text-white"  >
            <div class="masthead-content" >
              <div class="container px-5" style=" background: #e8e8e85c;border-radius: 10px; padding-bottom: 100px; padding-top: 120px;">
                <div class="closeInfo" onclick="location.href='http://handongapp.cafe24.com/admin_main'">X</div>
    ...
    var tag = `
      ...
      <html lang="en">
          ...
          <script>
            function color_pick(adminID,score,color){
              $.ajax({
               	type:'post',
                async:false,
                url:'http://handongapp.cafe24.com/change_color_pick',
                dataType:'text',
                data:{
                	adminID:adminID,
                	score:score,
            ...
            function change_title(adminID,title){
              $.ajax({
               	type:'post',
                async:false,
                url:'http://handongapp.cafe24.com/change_title',
                dataType:'text',
                data:{
                	adminID:adminID,
                  title:title.value
            ...
            function change_scoretext(adminID,score,color){
              $.ajax({
               	type:'post',
                async:false,
                url:'http://handongapp.cafe24.com/change_color_scoretext',
                dataType:'text',
                data:{
                  adminID:adminID,
                	score:score+'_text',
        ...
        <body id="page-top">
          ...
          <form action="/admin_main" method="post" style="text-align:center;">
            <input type="submit" value="관리자 화m면" style="margin-bottom: 20px; background:#B0E0E6; margin-top:30px; font-size:20px;border:0px; font-weight:bold; border-radius:20px; width:200px; height:50px"  /><br />
          </form>
          </br>
    ...
    for(var i = 0; i< url.length; i++){
      tag +=`
        <tr>
          ...
          <td class="tdCSS"><a href="http://handongapp.cafe24.com/user?id=${url[i].url}">${url[i].url}</td>
          <td class="tdCSS">
          ...
          <td class="tdCSS">
            <button class="bt-copy" onClick="copy_clipboard('http://handongapp.cafe24.com/user?id=${url[i].url}','img-copy${url[i].team_num}')">
          ...
          <td class="tdCSS">
            ...
            <script type="text/javascript">
              function kakaoShare(url_num) {
                  ...
                  content : {
                    title:"Team CC 링크",
                    description:"http://handongapp.cafe24.com/user?id=" + url_num,  // 콘텐츠 설명
                    imageUrl:"https://ifh.cc/g/CAOojM.png", // 썸네일 같은거
                    link : {
                      mobileWebUrl:"http://handongapp.cafe24.com/user?id=" + url_num,    // 모바일 카카오톡에서 사용하는 웹 링크 URL
                      webUrl:"http://handongapp.cafe24.com/user?id=" + url_num  // PC버전 카카오톡에서 사용하는 웹 링크 URL
                    }
                  },
                  buttons : [{
            ...
            <a href="http://handongapp.cafe24.com/admin_main" id="kakao_href"></a>
  ...
  activityTable:function(activity,activity_id){
    ...
    for(var i = 0; i< activity.length; i++){
      tag +=`
        <tr>
          <td class="tdCSS" width=50px >${i+1}</td>
          <td class="tdCSS tdActivity"><p class="pActivity">${activity[i].activity}</p></td>
          <td width="100px" class="tdCSS">${activity[i].score}</td>
          <td class="tdCSS">
            <form action="/activity_delete" method="post">
              <input type="hidden" name="id" value="${activity[i].id}">
      ...
      <html lang="en">
        ...
        <body id="page-top">
          ...
          <script>
            var point = document.getElementsByClassName("point_text");
            for(var i = 0; i< point.length; i++){
              if(point[i].innerText.length > 6){
                console.log(point[i].innerText.length);
                point[i].style.fontSize = "16vw / ";
              }
            }
          </script>
            ...
            <script type="text/javascript">
              function kakaoShare(url_num) {
                  ...
                  content : {
                    title:"Team CC 링크",
                    description:"http://handongapp.cafe24.com/user?id=" + url_num,  // 콘텐츠 설명
                    imageUrl:"https://ifh.cc/g/wbWqQd.jpg", // 썸네일 같은거
                    link : {
                      mobileWebUrl:"http://handongapp.cafe24.com/user?id=" + url_num,    // 모바일 카카오톡에서 사용하는 웹 링크 URL
                      webUrl:"http://handongapp.cafe24.com/user?id=" + url_num  // PC버전 카카오톡에서 사용하는 웹 링크 URL
                    }
        ...
        if(score_temp !== activity[i].score){
          ...
          temp +=`
            <td id="td_table">
              <p style="text-align:left; margin-left:20px; margin-bottom:2px; font-size:3vw;  font-family: 'Jua' ,sans-serif;color:${score_color};">${activity[i].score}학점</p>
              <div id="td_background" style="margin-left:12px; background:${activity[i].color};">
                <p id="point_5" class="point_text" style="color:${text_color}; ">${activity[i].activity}</p>
              </div>
            </td>`;
        }else{
          temp +=`
...
//----------------------------  color select -------------------------------------
  ...
  // main 화면 HTML
  main_HTML:function(team_info, activity_id, activity, url, url_team_num, admin_info, alertFlag){
    if(alertFlag === "noSession"){
      var modalTitle = '로그인을 다시 해주세요!';
      var modalContent = '로그인 세션 정보가 존재하지 않습니다.<br>로그인 화면으로 돌아갑니다!';
      var backURL = 'http://handongapp.cafe24.com';
          ...
          <body id="page-top">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
              <div class="container px-5" id="navbar-grid" style="margin: 0; display:grid; grid-template-columns: 30vw 60vw;">
                <div id="navbar-header" style="grid-column:1; text-align:left;"><a class="navbar-brand" href="/admin_main">Admin Page</a></div>
                <div id="navbar-item" style="grid-column:2; text-align:right;">
                  ...
                  <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <div class="navbar-rg-item"><img onclick="location.href='http://handongapp.cafe24.com/admin_profile'" src="assets/img/profileIcon.png" width="40px;"></div>
                  </div>
                </div>
              </div>
            </nav>
                    ...
                    <div class="p-5">
                      <div style="display:grid; margin-bottom:20px;   grid-template-rows: 50px 50px; grid-template-columns:2fr 1fr 0.5fr; place-items:centers;">
                        ...
                        <div class="wrapper" style="grid-row:1; grid-column:3; margin-left:20px; text-align:left; height: 40px; margin-right: 20px;">
                          ...
                          <a href="http://handongapp.cafe24.com/change_url_state" id="change_url_link"></a>
                        </div>
                        <script>
                        ...
                        <form action="/url_insert" style="grid-row:2; grid-column-start:2; grid-column-end:4; text-align:center;" method="post">
                          ...
                          <input type="submit" style="background-color: #6281D7; border-radius: 20px; vertical-align: middle; box-shadow: 3px 3px 5px grey; border:none;  height:40px; width:200px; color: white; font-size: 15px;" value="Add CC Team(URL)">
                        </form>
                      </div>
                      <table width="100%">
                    ...
                    <div class="p-5">
                      ...
                      <form action="admin_update_state" id="info_form" method="post" enctype="multipart/form-data">
                        <div id="info_grid">
                          ...
                          <input id="bt_info_submit" type="submit" value="Edit">
                        </div>
                      </form>
                      <script>
