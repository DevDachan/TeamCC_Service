module.exports = {
  ...
  // main 화면 table 생성 (전체 score)
  main_HTML:function(body,team_name,){
    var tag = `
    <!DOCTYPE html>
    <html lang="en">
        <head>
  ...
  urlTable:function(url,team_num){
    ...
    create_main_HTML:function(state, activity_id, activity, url, url_team_num){
      return `
      <!DOCTYPE html>
      <html lang="en">
          <head>
                  ...
                  <div class="container px-5">
                      ...
                      <div class="collapse navbar-collapse" id="navbarResponsive">
                          <ul class="navbar-nav ms-auto">
                              <li class="nav-item"><a class="nav-link" href="/main">Score Board</a></li>
