              ...
              <section>
                <div class="container px-5">
                  <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                      <div class="p-5">
                        <div style="display:grid; margin-bottom:10px;   grid-template-rows: 50px 50px; grid-template-columns:2fr 1fr 0.5fr; place-items:centers;">
            ...
            <div class="masthead">
                <div class="masthead-content text-white">
                    <div class="container-fluid px-4 px-lg-0" style="padding: 20px;">
                        ...
                        <!-- login box -->
                        <form style="width:400px;" action="http://localhost:8080/teamcc/developer/login_action" method="post">
                            <h4 id="lb_ID" >ID</h4>
...
// ----------------------- function (table, grid)  -----------------------------------------------------
  function_gallery:function(cc){
    ...
    for(var i = 0; i< cc.length; i ++){
      ...
      tag +=`
        <div class="col-sm-3">
          <img class="gallery-img" id="img_${cc[i].activity_id}_${cc[i].activity_index}" src="data:${cc[i].mimetype};base64,${cc[i].image}" width="100%" height=auto onclick="modal(${cc[i].activity_id},${cc[i].activity_index})"/>
