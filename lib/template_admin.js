module.exports = {
  ...
  image_HTML:function(activity,team_name){
    var tag = `
    <!DOCTYPE html>
    <html lang="en">
        <head>
        ...
        <body id="page-top">
            ...
            <header class="masthead text-center text-white" style="height:400px;">
                <div class="masthead-content">
                    <div class="container px-5">
                        <h3 class="masthead-heading mb-0"> TEAM CC</h3>
                    </div>
                </div>
                <div class="bg-circle-1 bg-circle"></div>
                <div class="bg-circle-2 bg-circle"></div>
            ...
            <p></p>
            <table id="tb_activityImage">
              ${this.activityImage(activity,team_name)}
            </table>
            <p></p>
            <form action="/admin_main" method="post" style="text-align:center;">
  ...
  urlTable:function(url,team_num){
    ...
    return tag;},
    activityImage:function(activity,team_name){
      var length = 24;

      var tag = `
      <tr>
        <td colspan=6 style="border:0px; ">
          <h3 class="display-4" style="margin:10px; font-family: 'Jua', sans-serif; color:white;"> ${team_name} TEAM CC </h3>
        </td>
      </tr>`;
      var temp = '';
      var color = ["#5AD2FF","#DCEBFF","#A0A0C8","#7FFFD4","#32A4FF","#FF98A3","#E6749D","#FFDBC1"];
      var text_list = ["white", "black"];
      var color_list = [];
      ...
      for(var i =0; i<length; i++){
        if(i < activity.length){
          temp +=`
            <td id="td_table">
              <div id="td_background" style="background:${color_list[activity[i].score]};">
                <p id="point_5" style="color:white; ">${activity[i].activity}</p>
              </div>
            </td>
          `;
        }
                      ...
                      <div class="row gx-5 align-items-center">
                          ...
                          <div class="col-lg-6 order-lg-1">
                              <div class="p-5">
                                  ...
                                  <a class="btn btn-primary btn-l rounded-pill " style="margin-left:20px;font-weight:bold;" href="activity_image">표로 보기</a>
                                  <p></p>
                                  <table>
