    ...
    activityImage:function(activity,team_info,color_db){
      ...
      <tr>
        <td colspan=6 style="border:0px; ">
          <h3 class="display-4" style="margin:10px; font-family: 'Jua', sans-serif; color:white;"> ${team_info.title}</h3>
        </td>
      </tr>`;
      var temp = '';
      var score_temp = 0;
      for(var i =0; i<length; i++){
        if(i < activity.length){
          if(score_temp !== activity[i].score){
            ...
            temp +=`
              <td id="td_table">
                <p style="text-align:left; margin-left:15px; font-size:1.5em;  font-family: 'Jua', sans-serif;">${activity[i].score}학점</p>
      ...
      <tr>
        <td colspan=2>
          <input type="text" style="padding:5px;" value="${team_info.title}" />
        </td>
      </tr>
      `;
      //-------------------------     merge table       ----------
