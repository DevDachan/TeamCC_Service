...
function head_contents(){
  return `
    ...
    <link href="/teamcc/css/styles.css" rel="stylesheet" />
    <link href="/teamcc/css/admin.css" rel="stylesheet" />
  `;
}
      ...
      <head>
        ...
        <script>
          function deleteFunction(){
            ...
            opener.parent.location = 'http://handongapp.cafe24.com/teamcc/admin_create';
            window.close();
          }
        </script>
      </head>
              ...
              <div class="container px-5" id="navbar-grid" style="margin: 0; display:grid; grid-template-columns: 30vw 60vw;">
                ...
                <div id="navbar-item" style="grid-column:2; text-align:right;">
                  ...
                  <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <div class="navbar-rg-item"><img onclick="location.href='http://handongapp.cafe24.com/teamcc/admin_profile'" src="assets/img/profileIcon.png" width="40px;"></div>
                  </div>
                </div>
              </div>
            </nav>
