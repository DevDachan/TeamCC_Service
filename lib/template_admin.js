    ...
    <html lang="en">
      ...
      <body onclick="window.close();" style="background-color: #3E4C65; text-align: center; margin-top: 50px; color: white;">
        ...
        <div style="margin-top: 25px;">
          <button onclick="window.close();" class="popup_btnCSS" style="background-color: tomato; color: white;">
            Delete
          </button>
          &nbsp;
...
=======
                <br />
                <br />
>>>>>>> dabc922 (feat: change js-alert to window.open)
    ...
    return`
      ...
      <html lang="en">
        ...
        <!-- Header -->
          <header class="masthead text-center text-white"  >
            <div class="masthead-content" >
              <div class="container px-5" style=" background: #e8e8e85c;border-radius: 10px; height: 60vh;padding-top: 40px;">
                ...
                <form style="margin:auto;width:400px;" action="/admin_main" method="post" onsubmit="return profile_edit();">
                  <div id="grid">
                    <h3 id="lb_ID" >ID</h3>
                    <input id="ip_id" name="id" required type="text" disabled value="${admin_info.id}"></input>

                    <h3 id="lb_curPWD" style="  margin-top: 5px;">Current Password</h3>
                    <input id="ip_curpwd" required name="curpwd" type="password"></input>

                    <h3 id="lb_newPWD" style="  margin-top: 5px;">New Password</h3>
                    <input id="ip_newpwd" required name="newpwd" type="password"></input>

                    <h3 id="lb_newPWD2" style="  margin-top: 5px;">Confirm</h3>
                    <input id="ip_newpwd2" required name="newpwd2" type="password"></input>
                    <label id="error_text" style="grid-column:span 2; font-weight:bold; color:red;"></label>
                ...
                <div class="col-lg-6">
                  <div class="p-5">
                    <div style="display:grid; margin-bottom:20px;   grid-template-rows: 50px 50px; grid-template-columns:2fr 1fr 0.5fr; place-items:centers;">
                      ...
                      <p style="grid-row:1; grid-column:2; white-space:nowrap; text-align:right; margin-top:0.5rem;"> Member State</p>
