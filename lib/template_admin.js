                ...
                <div class="masthead-content">
                    <div class="container px-5">
                        ...
                        <form style="  margin:auto;width:400px;" action="/admin_login" method="post">
                          <div id="grid">
                            <h3 id="lb_ID" >ID</h3>
                            <input id="ip_id" name="id" required type="text" value="chn7894"></input>
                            <h3 id="lb_PWD" style="  margin-top: 5px;">PWD</h3>
                            <input id="ip_pwd" required name="pwd" type="password" value="dac7894"></input>
      ...
      <html lang="en">
          ...
          <body id="page-top">
              ...
              <section>
				  ...
				  <p style="grid-row:1;grid-column:1; font-weight:bold;">Team member state</p>
				  <div class="wrapper" style="grid-row:1; grid-column:2;">
				   ${check_state} 
