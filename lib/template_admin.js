...
// ----------------------- function (table, grid)  -----------------------------------------------------
  function_gallery:function(cc){
    ...
    for(var i = 0; i< cc.length; i ++){
      ...
      tag +=`
        <div class="col-sm-3">
          <img id="img_${cc[i].activity_id}_${cc[i].activity_index}" src="data:${cc[i].mimetype};base64,${cc[i].image}" width="100%" height=auto onclick="modal(${cc[i].activity_id},${cc[i].activity_index})"/>
