module.exports = {
  ...
  image_HTML:function(activity,team_info,color_db,admin_id){
    var background_image_tag = 'assets/img/default_background.jpg';
    ...
    var tag = `
      ...
      <html lang="en">
        ...
        <body id="page-top">
          ...
          <br />
          ${this.activityImage(activity,team_info,color_db,admin_id)}
          <br />
    ...
    for(var i = 0; i< url.length; i++){
      tag +=`
        <tr>
          ...
          <td> <a href="http://localhost:80/user?id=${url[i].url}">${url[i].url}</td>
          <td>
  ...
  activityImage:function(activity,team_info,color_db,admin_id){
...
//----------------------------  color select -------------------------------------
      ...
      if(color_db[i].score !== "background" && color_db[i].score !== "text_color" && color_db[i].score !== "title_color" && color_db[i].score !== "score_color"){
        color_table +=`
          <tr>
            ...
            <td><input type="color" onChange="color_pick('${admin_id}','${color_db[i].score}',this)" name="color_${color_db[i].score}" value="${color_db[i].color}" style="border:0px;"></input></td>
          </tr>`;
      }
    }
    ...
    color_table +=`
      ...
      <tr>
        <td>배경</td>
        <td><input type="color" onChange="color_pick('${admin_id}','background',this)" name="background" value="${background_color}" style="border:0px;"></input></td>
      </tr>
      <tr>
        <td>제목</td>
        <td><input type="color" onChange="color_pick('${admin_id}','title_color',this)" name="title_color" value="${title_color}" style="border:0px;"></input></td>
      </tr>
      <tr>
        <td>학점</td>
        <td><input type="color" onChange="color_pick('${admin_id}','score_color',this)" name="score_color" value="${score_color}" style="border:0px;"></input></td>
      </tr>
      <tr>
        <td>내용</td>
        <td><input type="color" onChange="color_pick('${admin_id}','text_color',this)" name="text_color" value="${text_color}" style="border:0px;"></input></td>
      </tr>`;
              ...
              <div class="row gx-5 align-items-center">
                ...
                <div class="col-lg-6 order-lg-1">
                  <div class="p-5">
                      ...
                      <a class="btn btn-primary btn-l" style="grid-column:2;grid-row:1; margin:0px; font-weight:bold; border-radius:90px; height:70px; width:70px;  align-items: center;  display: flex; justify-content: center;" href="activity_image">Image </a>
				            </div>
                    <br />
                    <table>
